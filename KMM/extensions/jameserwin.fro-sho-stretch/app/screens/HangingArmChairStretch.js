...
export class HangingArmChairStretch extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      tableData: [
        [sadButton('0103', '1', 1),
          neutralButton('0103', '2', 2),
          happyButton('0103', '3', 3)],
      ],
      happyPhrases: [
      ...
      medPhrases: [
        'Don’t forget to warm up the affected area before this stretch! ',
        'Make sure the pressure from the chair is on your ribcage not your armpit.',
        'Aim to hold this stretch for up to 3 minutes, but when initially performing this stretch shorter durations are fine.',
      ...
      sadPhrases: [
        'Is this activity causing pain? Make sure you perform this stretch only to the point of slight tension or discomfort. It should not aggravate your condition. Make sure the pressure from the chair is on your ribcage not your armpit.',
        ...
        'Aim to hold this stretch for 1 to 3 minutes, but when initially performing this stretch shorter durations are fine.'
      ],
    }
  }
            ...
            <View style={{top:0, flex:1, height:880,paddingTop:20}} >
              <View style={{ height: 300 }}>
                <WebView
                    ...
                    source={{ uri: "https://www.youtube.com/embed/YH2RvRqhI7M" }}
                />
              </View>
...
export default connect(mapStateToProps, undefined)(HangingArmChairStretch);
