...
export class CrossBodyReach extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      tableData: [
        [sadButton('0101', '1', 1),
          neutralButton('0101', '2', 2),
          happyButton('0101', '3', 3)],
      ],
      happyPhrases: [
        ...
        'As you improve, you can gradually increase the elevation of your elbow aiming for shoulder height eventually.',
            ...
            <View style={{top:0, flex:1, height:880,paddingTop:20}} >
              <View style={{ height: 300 }}>
                <WebView
                    ...
                    source={{ uri: "https://www.youtube.com/embed/SvjfsCDxMAg" }}
                />
              </View>
