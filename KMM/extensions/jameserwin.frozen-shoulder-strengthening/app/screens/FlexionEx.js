...
//  example swipout app
export default class FlexionEx extends Component {
  ...
  render() {
    return (
        <View style={styles.container}>
          ...
          <View style={styles.navbar}><Text style={styles.navbarTitle}>Flexion Exercise with Towel or Wand</Text></View>
            ...
            <View style={{top:0, flex:1, height:800,paddingTop:20}} >
              <View style={{ height: 200 }}>
                <WebView
                    ...
                    source={{ uri: "https://www.youtube.com/embed/JB2nlF9Frpg" }}
