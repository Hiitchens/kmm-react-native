...
export class HandClaspShoSqueeze extends React.Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            tableData: [
                [sadButton('0205', '1', 1),
                    neutralButton('0205', '2', 2),
                    happyButton('0205', '3', 3)],
            ],
          happyPhrases: [
            ...
            <View style={styles.container}>
                <Text
                    style={{
                        ...
                        alignSelf: 'center',
                        color:'#000000'
                    }}>Hand Clasp Shoulder Blade Squeeze
                </Text>
                    ...
                    <View style={{top:0, flex:1, height:1190,paddingTop:20}} >
                        <View style={{ height: 300 }}>
                            <WebView
                                ...
                                source={{ uri: "https://www.youtube.com/embed/IUZYAzERxmM" }}
                            />
                        </View>
...
export default connect(mapStateToProps, undefined)(HandClaspShoSqueeze);
