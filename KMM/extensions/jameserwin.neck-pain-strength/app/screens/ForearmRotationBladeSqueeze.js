...
export class ForearmRotationBladeSqueeze extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            tableData: [
                [sadButton('0204', '1', 1),
                    neutralButton('0204', '2', 2),
                    happyButton('0204', '3', 3)],
            ],
          happyPhrases:[
            'Make sure you breathe slowly while performing this strengthening activity and keep your shoulders down.',
          ...
          medPhrases: [
            'Don’t forget to stretch before performing this activity. ',
            'If 10 repetitions is too much, try working up to this over time.',
          ...
          sadPhrases: [
            ...
            'If 10 repetitions is too much, try working up to this over time.',
            'Talk to your therapist at your next appointment about modifying this activity if you cannot perform it without pain.',
        ...
        return (
            <View style={styles.container}>
                ...
                <ScrollView scrollingEnabled={true}>
                    <View style={{top:0, flex:1, height:1110,paddingTop:20}} >
