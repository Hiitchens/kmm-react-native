...
export class NWB_CalfStretch extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      tableData: [
        [sadButton('0301', '1', 1),
          neutralButton('0301', '2', 2),
          happyButton('0301', '3', 3)],
      ],
      happyPhrases: [
        'One of the causes of plantar fasciitis is tight calf muscles, so performing this stretch is important.',
        'Ensure your knee is straight for this stretch in order to stretch the higher, gastrocnemius muscle.',
    ...
    return (
        <View style={styles.container}>
          ...
          <ScrollView scrollingEnabled={true}>
            <View style={{top:0, flex:1, height:865,paddingTop:20}} >
              <View style={{ height: 300 }}>
                <WebView
                    ...
                    source={{ uri: "https://www.youtube.com/embed/qvyep51GkCM" }}
                />
              </View>
              ...
              <Text
                  ...
                  •	Gently pull the strap toward you while keeping your knee straight.{"\n"}{"\n"}
                  •	You should feel the stretch in the arch of your foot and in your calf.{"\n"}{"\n"}
...
export default connect(mapStateToProps, undefined)(NWB_CalfStretch);
