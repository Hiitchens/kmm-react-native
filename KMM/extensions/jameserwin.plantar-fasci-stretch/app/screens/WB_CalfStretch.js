...
export class WB_CalfStretch extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      tableData: [
        [sadButton('0303', '1', 1),
          neutralButton('0303', '2', 2),
          happyButton('0303', '3', 3)],
      ],
      happyPhrases: [
        ...
        'Ensure your knee is straight for this stretch in order to stretch the higher calf muscle.',
        ...
        <View style={styles.container}>
          <Text
              style={{
                ...
                alignSelf: 'center',
                color:'#000000'
              }}>Weighted Gastrocnemius Stretch
          </Text>
            ...
            <View style={{top:0, flex:1, height:875,paddingTop:20}} >
              <View style={{ height: 300 }}>
                <WebView
                    ...
                    source={{ uri: "https://www.youtube.com/embed/12p4B8fPTdM" }}
                />
              </View>
              ...
              <Text
                ...
                •	Keep your back leg straight with the heel on the floor.{"\n"}{"\n"}
                •	Bend your front knee until you feel a gentle stretch in the upper calf region of your back leg.{"\n"}{"\n"}
...
export default connect(mapStateToProps, undefined)(WB_CalfStretch);
