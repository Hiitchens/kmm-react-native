...
import {StyleSheet, Button, View, Text, TouchableOpacity, ScrollView, Alert, WebView, TouchableWithoutFeedback} from 'react-native';
...
export class DowelBroom extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      tableData: [
        [sadButton('0308', '1', 1),
          neutralButton('0308', '2', 2),
          happyButton('0308', '3', 3)],
        ...
        <View style={styles.container}>
          <Text
              style={{
                ...
                alignSelf: 'center',
                color:'#000000'
              }}>Dowel/Broomstick Stretch
          </Text>
          <ScrollView scrollingEnabled={true}>
            <View style={{top:0, flex:1, height:1250,paddingTop:20}} >
              <View style={{ height: 300 }}>
                <WebView
                    ...
                    source={{ uri: "https://www.youtube.com/embed/ITNlYOwtF0A" }}
                />
              </View>
              ...
              <Text
                  ...
                  •	While sitting, place the dowel or broomstick on the floor in front of you.{"\n"}{"\n"}
                  ...
                  •	Additional Tips:{"\n"}{"\n"}
                  •	As the condition becomes less painful and you are able to bear weight on the arch of the foot, increase the pressure on the dowel{"\n"}{"\n"}
                  •	You can also progress to performing this activity in a standing position.{"\n"}{"\n"}
...
export default connect(mapStateToProps, undefined)(DowelBroom);
