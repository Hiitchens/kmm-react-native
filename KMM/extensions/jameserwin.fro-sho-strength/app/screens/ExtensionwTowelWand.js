...
export class ExtensionwTowelWand extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      tableData: [
        [sadButton('0107', '1', 1),
          neutralButton('0107', '2', 2),
          happyButton('0107', '3', 3)],
      ],
      happyPhrases: [
        'Maintain a straight back with shoulders down while performing this activity.',
      ...
      medPhrases: [
        ...
        'Maintain a straight back with shoulders down while performing this activity.',
        'Discomfort is allowable, but only lift your arms away from your back as far as you can without pain.',
        ...
        <View style={styles.container}>
          <Text
              style={{
                ...
                alignSelf: 'center',
                color:'#000000'
              }}>Extension with Towel or Wand
          </Text>
          <ScrollView scrollingEnabled={true}>
            <View style={{top:0, flex:1, height:950,paddingTop:20}} >
              <View style={{ height: 300 }}>
                <WebView
                    ...
                    source={{ uri: "https://www.youtube.com/embed/TetFnsoMJvY" }}
                />
              </View>
              ...
              <Text
                  ...
                  •	Stand upright and hold the towel or wand in both hands behind your back, palms facing upwards.{"\n"}{"\n"}
                  •	With arms straight, move the towel/wand away from your back.{"\n"}{"\n"}
...
export default connect(mapStateToProps, undefined)(ExtensionwTowelWand);
